...
class RequestTaskRecord(SQLModel, table=True):
    ...
    __tablename__: str = "request_task_queue"  # pyright: ignore[reportIncompatibleVariableOverride]
...
class TestMod:
    ...
    def test_request_task_raises_on_invalid_group(self) -> None:
        """
        docs:
            目的:
